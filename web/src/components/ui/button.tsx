...
export interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement>, VariantProps<typeof buttonVariants> {
	asChild?: boolean;
	pending?: boolean;
	pendingLocation?: "start" | "center" | "end";
}

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
	({ className, variant, size, disabled, pending, children, pendingLocation = "center", asChild = false, ...props }, ref) => {
				...
				{pending && (
					<div
						className={cn(
							...
							{ "justify-end mr-4": pendingLocation === "end" },
							{ "justify-start ml-4": pendingLocation === "start" },
							{ "justify-center": pendingLocation === "center" }
						)}
